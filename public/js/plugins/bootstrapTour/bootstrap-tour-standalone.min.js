...
function (t) {
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        if (o || (o = new this.constructor(e.currentTarget, this.getDelegateOptions()), t(e.currentTarget).data("bs." + this.type, o)), e instanceof t.Event && (o.inState["focusin" == e.type ? "focus" : "hover"] = !0), o.tip().hasClass("in") || "in" == o.hoverState) o.hoverState = "in";
        else {
...
function (t, e) {
    ...
    return e = window.document, function () {
        ...
        return o.prototype.addSteps = function (t) {
            ...
            return this._debug("Scroll into view. ScrollTop: " + a + ". Element offset: " + s + ". Window height: " + h + "."), i = 0, t("body, html").stop(!0, !0).animate({
            ...
            for (s = t(e).height(), c = t(e).width(), u = [], a = 0, p = (l = ["top", "bottom", "left", "right"]).length; a < p; a++) switch (h = l[a], i = null != (r = this.backdrops)[h] ? r[h] : r[h] = t("<div>", {
                class: "tour-backdrop " + h
            }), t(o.backdropContainer).append(i), h) {
            case "top":
                u.push(i.height(n.offset.top > 0 ? n.offset.top : 0).width(c).offset({
                    top: 0,
                    left: 0
                }));
                break;
