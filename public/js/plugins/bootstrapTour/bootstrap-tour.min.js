...
function (t, e) {
    ...
    return o = window.document, e = function () {
        ...
        return e.prototype.addSteps = function (t) {
            ...
            return this.ended() ? (this._debug("Tour ended, showStep prevented."), this) : (a = this.getStep(t), a && (s = t < this._current, n = this._makePromise(null != a.onShow ? a.onShow(this, t) : void 0), this.setCurrentStep(t), e = function () {
                ...
                return function () {
                    ...
                    return o = function () {
                        return e.getCurrentStep() !== t || e.ended() ? void 0 : (null != a.element && a.backdrop && e._showOverlayElement(a), e._showPopover(a, t), null != a.onShown && a.onShown(e), e._debug("Step " + (e._current + 1) + " of " + e._options.steps.length))
            ...
            var i, r, s, a, u, p, h;
            if (a = e[0].offsetWidth, r = e[0].offsetHeight, h = e.offset(), u = h.left, p = h.top, i = t(o).outerHeight() - h.top - e.outerHeight(), 0 > i && (h.top = h.top + i), s = t("html").outerWidth() - h.left - e.outerWidth(), 0 > s && (h.left = h.left + s), h.top < 0 && (h.top = 0), h.left < 0 && (h.left = 0), e.offset(h), "bottom" === n.placement || "top" === n.placement) {
                if (u !== h.left) return this._replaceArrow(e, 2 * (h.left - u), a, "left")
            } else if (p !== h.top) return this._replaceArrow(e, 2 * (h.top - p), r, "top")
            ...
            switch (i = t(window), a = n.offset().top, s = n.outerHeight(), p = i.height(), u = 0, e.placement) {
            case "top":
                u = Math.max(0, a - p / 2);
                break;
            case "left":
            ...
            return this._debug("Scroll into view. ScrollTop: " + u + ". Element offset: " + a + ". Window height: " + p + "."), r = 0, t("body, html").stop(!0, !0).animate({
        ...
        }, e.prototype._showBackground = function (e, n) {
            var i, r, s, a, u, p, h, l, c;
            for (r = t(o).height(), a = t(o).width(), l = ["top", "bottom", "left", "right"], c = [], p = 0, h = l.length; h > p; p++) switch (s = l[p], i = null != (u = this.backdrops)[s] ? u[s] : u[s] = t("<div>", {
                "class": "tour-backdrop " + s
            }), t(e.backdropContainer).append(i), s) {
            case "top":
                c.push(i.height(n.offset.top > 0 ? n.offset.top : 0).width(a).offset({
                    top: 0,
                    left: 0
                }));
                break;
            case "bottom":
                c.push(i.offset({
                    ...
                    left: 0
                }).height(r - (n.offset.top + n.height)).width(a));
                break;
            case "left":
                c.push(i.offset({
                    top: n.offset.top,
            ...
            case "right":
                ...
                }).height(n.height).width(a - (n.offset.left + n.width)));
                break;
            default:
                c.push(void 0)
            }
            return c
        }, e.prototype._showOverlayElement = function (e) {
            var o, n;
            return o = t(e.backdropElement), 0 !== o.length ? (n = {
                width: o.innerWidth(),
                height: o.innerHeight(),
                offset: o.offset()
            }, o.addClass("tour-step-backdrop"), e.backdropPadding && (n = this._applyBackdropPadding(e.backdropPadding, n)), this._showBackground(e, n)) : void 0
        }, e.prototype._hideOverlayElement = function (e) {
            var o, n, i;
            t(e.backdropElement).removeClass("tour-step-backdrop"), i = this.backdrops;
            for (n in i) o = i[n], o.remove();
